class people::jabley::repos {
  ...
  github {[
    ...
    'DigitalInnovation/bosh-concourse-setup',
    ...
    'DigitalInnovation/cfto-cf-metrics',
    'DigitalInnovation/cfto-metrics',
    'DigitalInnovation/cfto_test',
    'DigitalInnovation/dachs-cf-buildpack-guarddog',
    'DigitalInnovation/dachs-cf-buildpack-multi',
    'DigitalInnovation/dachs-cf-docker',
    'DigitalInnovation/dachs-cf-logging',
    'DigitalInnovation/dachs-walkies-pipelines',
